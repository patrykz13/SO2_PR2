...
Block::Block(int xPosition, __useconds_t stepDelay, chtype segmentChar, int screenWidth, int screenHeight)
        : stepDelay(stepDelay), xPosition(xPosition), segmentChar(segmentChar), screenWidth(screenWidth),
